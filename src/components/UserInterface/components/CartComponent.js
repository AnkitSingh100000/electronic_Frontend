...
export default function Cartomponent(props)
{
    ...
    return data.map((item)=>{
      ...
      return(<div>           
            ...
            <div style={{width:matches?'50%':'60%',marginLeft:'2%',padding:5}}>
                ...
                <b>{item.brandname} {item.productname} {item.modelno}</b>
                </div>
                <br></br>
      ...
      />
                ...
                <br></br>
                <div style={{display:'flex',flexDirection:'row'}}>
                <div  style={{border:'1px solid #000',width:matches?'50%':'32%',alignItems:'center',borderRadius:8,marginTop:'-2%',display:'flex',justifyContent:'center',background:'#fff',fontSize:matches?10:15}}>
    ...
    return(<div style={{width:matches?'98%':'100%'}}>
      ...
      >
       ...
       <span>  <FormControlLabel value="standard" control={<Radio />}/><span><AssignmentTurnedInIcon style={{marginBottom:'-2%',marginLeft:'-4%'}}/></span><span style={{fontSize:15}}><b>Standard Delivery by tomorrow</b></span></span>
             ...
             <div style={{marginTop:'4%'}}>
             <span style={{fontSize:16}}>Original Price<span style={{fontSize:16,marginLeft:'auto'}}>₹12,792.00</span></span>
             </div>
             <div style={{marginTop:'4%'}}>
