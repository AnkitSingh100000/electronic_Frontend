  ...
  var dispatch=useDispatch()
   ...
   const validation=()=>{
    ...
    const handleSubmit=async()=>{
        ...
        if(error==false)
        {
       var body={title:title,username:`${userName} ${middleName} ${lastName}`,mobileno:number,emailid:email,address:`${state} ${city} ${address}`,pincode:pincode}
       ...
       <b>ENTER SHIPPING INFORMATION</b>
        ...
        <div style={{width:'85%',height:'auto',borderRadius:5,background:'#fff',padding:15}}>
         ...
         <div style={{marginLeft:'5%'}}>
          ...
          <div>
            <div  style={{fontSize:13,padding:4}} >
             ...
             <TextField error={errors.state}  onFocus={()=>handleError('','state')} helperText={errors.state} value={state} onChange={(event)=>setstate(event.target.value)} size="small"  style={{background:'#f1f2f6',width:'29ch',borderRadius:'3%'}}/>       
         </div>
          <div>
         ...
         <div  style={{fontSize:13,padding:4}}>
            ...
            <div>
             <TextField error={errors.city}  onFocus={()=>handleError('','city')} helperText={errors.city} value={city} onChange={(event)=>setCity(event.target.value)} size="small"  style={{background:'#f1f2f6',width:'29ch',borderRadius:'3%'}}/>       
         </div>
         </div>
      </div>
         <div style={{marginLeft:'5%'}}>
